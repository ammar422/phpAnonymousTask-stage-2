...
class CategoriesHasSaubiscripers extends Value
{
    ...
    {
        return
            $this->count(Category::class, function ($q) {
                $q->whereHas('users');
            ...
            ->icon('<i class="fa fa-battery-full"></i>') // icon by fontawesome or other | optional
            // ->title('Your Title') // optional
            ->subTitle('Occupied Categories') // optional
