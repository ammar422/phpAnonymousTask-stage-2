...
class EmptyCategory extends Value
{
    ...
    {
        return
            $this->count(Category::class, function ($qu) {
                $qu->whereDoesntHave('users');
            ...
            ->icon('<i class="fa fa-battery-empty"></i>') // icon by fontawesome or other | optional
            ->title('Empty categories') // optional
